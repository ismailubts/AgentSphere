...
# can't be a legitimate AgentSphere collection name.
...
class MilvusClient(VectorDBBase):
    ...
    def _get_collection_and_resource_id(self, collection_name: str) -> Tuple[str, str]:
        ...
        WARNING: This mapping relies on current AgentSphere naming conventions for
        collection names. If AgentSphere changes how it generates collection names
