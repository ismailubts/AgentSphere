<script lang="ts">
	...
	const onDragOver = (e: DragEvent) => {
		...
		if (
			...
			e.dataTransfer?.types?.includes('application/x-agentsphere-drag')
		) {
			dragged = true;
		} else {
			dragged = false;
				...
				<div class="">
					...
					>
						...
						<div
							...
							class="as-input-card flex-1 flex flex-col relative w-full rounded-3xl border {$temporaryChatEnabled
								? 'border-dashed border-gray-100 dark:border-gray-800 hover:border-gray-200 focus-within:border-gray-200 hover:dark:border-gray-700 focus-within:dark:border-gray-700'
								: ''} transition px-1 dark:text-gray-100"
