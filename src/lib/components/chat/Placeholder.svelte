...
<div class="m-auto w-full max-w-6xl px-2 @2xl:px-20 translate-y-4 py-20 text-center">
		...
		<div class="w-full flex flex-col justify-center items-center">
			...
			{:else}
				<div class="flex flex-row justify-center gap-2.5 @sm:gap-3 w-fit px-5 max-w-xl">
								...
								>
									...
									>
										<img
											...
											class="as-hero-avatar size-11 @sm:size-12 rounded-2xl border-[1px] border-gray-100 dark:border-none"
											aria-hidden="true"
											draggable="false"
											on:error={(e) => {
					...
					<div
						class="as-hero-title text-3xl @sm:text-4xl line-clamp-1 flex items-center"
							...
							{#if models[selectedModelIdx]?.info?.meta?.user}
								<div class="mt-0.5 text-sm font-normal text-gray-400 dark:text-gray-500">
									...
									{#if models[selectedModelIdx]?.info?.meta?.user.community}
										<a
											href="https://github.com/ismailubts/AgentSphere/m/{models[selectedModelIdx]?.info?.meta?.user
												.username}"
