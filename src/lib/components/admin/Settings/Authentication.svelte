					...
					{#if adminConfig?.ENABLE_API_KEYS_ENDPOINT_RESTRICTIONS}
						<div class=" flex w-full flex-col pr-2 mb-2.5">
							...
							<div class="mt-2 text-xs text-gray-400 dark:text-gray-500">
								<a
									href="https://github.com/ismailubts/AgentSphere/reference/api-endpoints"
									target="_blank"
						...
						<div class="mt-2 text-xs">
							...
							>
								<div>
									...
									<span
										><a
											href="https://github.com/ismailubts/AgentSphere/reference/env-configuration#jwt_expires_in"
											target="_blank"
											class=" underline"
